...
Для сімейств потрібна вже наявна міграція `20260907154353_multilingual_product_taxonomy.sql`
та заповнена класифікація позицій. Ця доробка не застосовує міграцій і не
підтверджує production deployment.
