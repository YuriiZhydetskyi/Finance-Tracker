...
- **Negative line items**: `unit_price_orig` may be negative (cancellation, Pfand refund, Rabatt). `qty` always positive. See ADR-0012 + `pair-detector.ts` for client-side grouping logic.
